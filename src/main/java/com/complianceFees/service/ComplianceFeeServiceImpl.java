package com.complianceFees.service;
...
@Component
public class ComplianceFeeServiceImpl implements ComplianceFeeService {
    ...
    public String checkComplianceFees(String upcNumber, String stateCode) {
